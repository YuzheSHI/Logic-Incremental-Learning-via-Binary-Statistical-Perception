...
def task_2(args, device, train_loader, test_loader):
    ...
    for k in range(0, len(testing)):
        ...
        for i in range(0, len(h)): 
            ...
            if testing[k][1][i] == 0:
                y000.append(y_0[i][0].item())
                y001.append(y_0[i][1].item())
                y010.append(y_1[i][0].item())
                y011.append(y_1[i][1].item())
            elif testing[k][1][i] == 1:
                y100.append(y_0[i][0].item())
                y101.append(y_0[i][1].item())
                y110.append(y_1[i][0].item())
                y111.append(y_1[i][1].item())
        ...
        #plt.plot(x0, y000, marker = 'o', label = "0 of f_0")
        #plt.plot(x0, y001, marker = 'o', label = "1 of f_0")
        #plt.plot(x0, y010, marker = 'o', label = "0 of f_1")
        #plt.plot(x0, y011, marker = 'o', label = "1 of f_1")
        plt.plot(x1, y100, marker = '*', label = "0 of f_0, novel")
        plt.plot(x1, y101, marker = '*', label = "1 of f_0, novel")
        #plt.plot(x1, y110, marker = '*', label = "0 of f_1, novel")
        #plt.plot(x1, y111, marker = '*', label = "1 of f_1, novel")
        plt.legend(loc = 'best')
        plt.title("Prediction of Classes")
        plt.xlabel("Samples")
        plt.ylabel("Softmax")
        figname = "class_2" + str(k)
        plt.savefig(figname)
